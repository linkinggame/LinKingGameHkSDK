...
-(BOOL)startNotifier
{
    ...
    {
#ifdef DEBUG
        LKLogInfo(@"SCNetworkReachabilitySetCallback() failed: %s", SCErrorString(SCError()));
#endif
    ...
    {
#ifdef DEBUG
        LKLogInfo(@"SCNetworkReachabilitySetDispatchQueue() failed: %s", SCErrorString(SCError()));
#endif
